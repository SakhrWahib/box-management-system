            ...
            <div class="flex justify-between h-14">
                <div class="flex items-center space-x-4 space-x-reverse">
                    <div class="flex-shrink-0 flex items-center">
                        ...
                        <span class="text-lg font-bold text-gray-800">نظام المستودع</span>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-6">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <form action="{{ route('admin.logout') }}" method="POST" class="m-0">
                            @csrf
                            <button type="submit" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg transition-colors duration-300 flex items-center gap-2">
    ...
    <aside class="fixed right-0 top-14 w-64 h-full bg-[#1e1b4b] text-white">
        <div class="flex items-center justify-center h-16 border-b border-indigo-900/30">
            <div class="flex items-center">
                ...
                <h1 class="text-xl font-bold text-gray-100">نظام المستودع</h1>
            </div>
        </div>
        <nav class="mt-6">
            <div class="px-4 space-y-2">
                <a href="{{ route('boxes-under-manufacturing.index') }}" 
                    ...
                    <div class="bg-indigo-500/20 p-2.5 rounded-lg ml-3 group-hover:bg-indigo-500/30 transition-colors duration-300">
                        <i class="fas fa-box text-indigo-300 text-lg"></i>
                    </div>
                    <span class="font-medium tracking-wide">الصناديق قيد التصنيع</span>
                </a>

                <a href="{{ route('workshops-and-box-types.index') }}" 
                    class="flex items-center text-gray-100 p-3 rounded-lg hover:bg-white/10 transition-all duration-300 group transform hover:-translate-x-1">
                    <div class="bg-indigo-500/20 p-2.5 rounded-lg ml-3 group-hover:bg-indigo-500/30 transition-colors duration-300">
                        <i class="fas fa-tools text-indigo-300 text-lg"></i>
                    </div>
                    <span class="font-medium tracking-wide">سجلات الورش</span>
                </a>

                <a href="{{ route('manufactured-boxes.index') }}" 
                    class="flex items-center text-gray-100 p-3 rounded-lg hover:bg-white/10 transition-all duration-300 group transform hover:-translate-x-1">
                    <div class="bg-indigo-500/20 p-2.5 rounded-lg ml-3 group-hover:bg-indigo-500/30 transition-colors duration-300">
                        <i class="fas fa-boxes text-indigo-300 text-lg"></i>
                    </div>
                    <span class="font-medium tracking-wide">الصناديق المصنعة</span>
                </a>

                <a href="{{ route('inventory-boxes.index') }}" 
                    class="flex items-center text-gray-100 p-3 rounded-lg hover:bg-white/10 transition-all duration-300 group transform hover:-translate-x-1">
                    <div class="bg-indigo-500/20 p-2.5 rounded-lg ml-3 group-hover:bg-indigo-500/30 transition-colors duration-300">
                        <i class="fas fa-box-archive text-indigo-300 text-lg"></i>
                    </div>
                    <span class="font-medium tracking-wide">الصناديق الموجودة</span>
                </a>

                <a href="{{ route('workshops-and-box-types.archive') }}" 
                    class="flex items-center text-gray-100 p-3 rounded-lg hover:bg-white/10 transition-all duration-300 group transform hover:-translate-x-1">
                    <div class="bg-indigo-500/20 p-2.5 rounded-lg ml-3 group-hover:bg-indigo-500/30 transition-colors duration-300">
                        <i class="fas fa-folder-open text-indigo-300 text-lg"></i>
                    </div>
                    <span class="font-medium tracking-wide">الأرشيف</span>
                </a>
            </div>
        </nav>
    </aside>
